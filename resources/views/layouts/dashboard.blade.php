            ...
            <div class="top-menu">
                <ul class="nav navbar-nav pull-right">
                    ...
                    <li class="dropdown dropdown-user">
                        <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                            <img alt="" class="img-circle" src="Dashboard/assets/layouts/layout2/img/avatar3_small.jpg" />
...
<div class="page-footer">
    ...
    function updateUser(e){
        var id = $("#user_id_in");
        var name = $('#user_name_in');
        var email = $('#user_email_in');
        removeAlert();
        $.ajax({
            method: 'POST',
            url: '/update-user-ajax/',
            dataType: 'html',
            data: {
                '_token': "{{ csrf_token() }}",
                'id': id.val(),
