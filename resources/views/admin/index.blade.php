                        ...
                        <div class="col-lg-6 col-xs-12 col-sm-12">
                            <div class="portlet light ">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <span class="caption-subject bold uppercase font-dark">Members</span>
                                        <span class="caption-helper">{{ count($users) }}</span>
                                    </div>
                                    <div class="actions">
                                            ...
                                            <table class="table">
                                                <tr>
                                                    ...
                                                    <th class="text-center">
                                                        <button  id="create_user_modal" class="create-user-modal btn btn-primary btn-sm" data-toggle="modal" data-target="#modal" onclick="loadModalContent('admin/modal/add-user')">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <button href="#" class="edit-user-modal btn btn-warning btn-sm" data-toggle="modal" data-target="#modal" onclick="loadModalContent('admin/modal/edit-user/{{$user->id}}')" >
                                                            <i class="fa fa-pencil"></i>
                                                        </button>
                                                        <a href="#" class="delete-user-modal btn btn-danger btn-sm" data-toggle="modal" data-target="#modal" onclick="loadModalContent('admin/modal/delete-user/{{$user->id}}')">
                                    ...
                                    <div id="dashboard_amchart_3" class="CSSAnimationChart">
                                        <div>
                                            <table class="table">
                                                ...
                                                <tr>
                                                    <td>{{$msg->id}}</td>
                                                    <td><b>{{$msg->chat_id}}</b></td>
                                                    <td>{{$msg->user_id}}</td>
                                                    <td>{{$msg->body}}</td>
                                                    <td>{{$msg->updated_at->diffForHumans()}}</td>
                                                    <td class="text-center">
                                                        <button href="#" class="edit-skill-modal btn btn-warning btn-sm" data-toggle="modal" data-target="#modal" onclick="loadModalContent('admin/modal/edit-skill/{{$msg->id}}')" >
                                                            <i class="fa fa-pencil"></i>
                                                        </button>
                                                        <a href="#" class="delete-skill-modal btn btn-danger btn-sm" data-toggle="modal" data-target="#modal" onclick="loadModalContent('admin/modal/delete-skill/{{$msg->id}}')">
                                                            <i class="fa fa-trash"></i>
                                                        </a>
                                                    </td>
                                                </tr>
                                ...
                                <div class="portlet-body">
                                    ...
                                    <div class="table-scrollable table-scrollable-borderless">
                                        <table class="table table-hover table-light">
                                            ...
                                            <tr>
                                                <td class="fit">
                                                    <img class="user-pic rounded" src="Dashboard/assets/pages/media/users/avatar4.jpg"> </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td class="fit">
                                                    <img class="user-pic rounded" src="Dashboard/assets/pages/media/users/avatar5.jpg"> </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td class="fit">
                                                    <img class="user-pic rounded" src="Dashboard/assets/pages/media/users/avatar6.jpg"> </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td class="fit">
                                                    <img class="user-pic rounded" src="Dashboard/assets/pages/media/users/avatar7.jpg"> </td>
                                                <td>
                                    ...
                                    <div class="scroller" style="height: 338px;" data-always-visible="1" data-rail-visible1="0" data-handle-color="#D7DCE2">
                                        <div class="general-item-list">
                                            <div class="item">
                                                <div class="item-head">
                                                    <div class="item-details">
                                                        <img class="item-pic rounded" src="Dashboard/assets/pages/media/users/avatar4.jpg">
                                            ...
                                            <div class="item">
                                                <div class="item-head">
                                                    <div class="item-details">
                                                        <img class="item-pic rounded" src="Dashboard/assets/pages/media/users/avatar3.jpg">
                                            ...
                                            <div class="item">
                                                <div class="item-head">
                                                    <div class="item-details">
                                                        <img class="item-pic rounded" src="Dashboard/assets/pages/media/users/avatar6.jpg">
                                                        <a href="" class="item-name primary-link">Nick Larson</a>
                                            ...
                                            <div class="item">
                                                <div class="item-head">
                                                    <div class="item-details">
                                                        <img class="item-pic rounded" src="Dashboard/assets/pages/media/users/avatar7.jpg">
                                                        <a href="" class="item-name primary-link">Nick Larson</a>
                                            ...
                                            <div class="item">
                                                <div class="item-head">
                                                    <div class="item-details">
                                                        <img class="item-pic rounded" src="Dashboard/assets/pages/media/users/avatar9.jpg">
                                            ...
                                            <div class="item">
                                                <div class="item-head">
                                                    <div class="item-details">
                                                        <img class="item-pic rounded" src="Dashboard/assets/pages/media/users/avatar8.jpg">
                                            ...
                                            <div class="item">
                                                <div class="item-head">
                                                    <div class="item-details">
                                                        <img class="item-pic rounded" src="Dashboard/assets/pages/media/users/avatar2.jpg">
